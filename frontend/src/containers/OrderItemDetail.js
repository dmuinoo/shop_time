...
const OrderItemDetail = ({ match, get_order_detail, order }) => {
  useEffect(() => {
  ...
  return (
    <div className="container mt-3">
      <Helmet>
        ...
        />
        <title>Shop Time | Order Item Detail</title>
        {/*<link rel="canonical" href="http://mysite.com/activate" /> */}
      </Helmet>
      <h1 className="mb-5">Order Details</h1>
      <Link className="btn btn-primary mb-5" to="/dashboard">
        Back to Dashboard
      </Link>
      <div className="card mb-5">
        <h3 className="card-header">Full Order Purchase Details</h3>
        <div className="card-body">
          {order && order !== null && order !== undefined && (
            <ul className="list-group mb-3">
              <div>
                <h3 className="text-muted mb-3" style={{ fontSize: "18px" }}>
                ...
                <ul className="list-group mb-3">
                  ...
                  <li className="list-group-item">City: {order.city}</li>
                  <li className="list-group-item">
