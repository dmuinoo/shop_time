...
const ProductDetail = ({
  ...
  const getLeaveReviewComponent = () => {
    if (isAuthenticated) {
      ...
      return (
        <button className="btn btn-warning" onClick={requireLogin}>
  ...
  return (
    <div className="container mt-5">
      ...
      <section className="mt-5">
        ...
        <div className="row mt-5 ml-5 mr-5">{getRelatedProducts()}</div>
      </section>
      ...
      <section className="mt-5 mb-5">
        <div className="row">
          <div className="col-3">
            ...
            <p className="mb-3">Share your thoughts with other customers</p>
