...
export const get_products = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get(
      `${process.env.REACT_APP_API_URL}/api/products/get-products`,
      config
    );
...
export const get_products_by_arrival = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get(
      `${process.env.REACT_APP_API_URL}/api/products/get-products?sortBy=date_created&order=desc&limit=3`,
      config
    );
...
export const get_products_by_sold = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get(
      `${process.env.REACT_APP_API_URL}/api/products/get-products?sortBy=sold&order=desc&limit=3`,
      config
    );
  ...
  (category_id, price_range, sort_by, order) => async (dispatch) => {
    ...
    try {
      const res = await axios.post(
        `${process.env.REACT_APP_API_URL}/api/products/by/search`,
        body,
        config
      );
