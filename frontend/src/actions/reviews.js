...
export const create_review =
  (product_id, rating, comment) => async (dispatch) => {
    if (localStorage.getItem("access")) {
      const config = {
        headers: {
          Authorization: `JWT ${localStorage.getItem("access")}`,
...
export const filter_reviews = (product_id, rating) => async (dispatch) => {
  ...
  else if (rating === 1 || rating === 1.0) myRating = "1.0";
  else if (rating === 1.5) myRating = "1.5";
  else if (rating === 2 || rating === 2.0) myRating = "2.0";
  else if (rating === 2.5) myRating = "2.5";
  else if (rating === 3 || rating === 3.0) myRating = "3.0";
  else if (rating === 3.5) myRating = "3.5";
  else if (rating === 4 || rating === 4.0) myRating = "4.0";
