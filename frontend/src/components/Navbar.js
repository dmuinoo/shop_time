...
const Navbar = ({
  ...
  const authLinks = (
    <li className="nav-item">
      <a className="nav-link mt-1" onClick={logoutHandler} href="#!">
        Logout
      </a>
    </li>
  );
  ...
  const guestLinks = (
    <Fragment>
      <li className="nav-item">
        <NavLink className="nav-link mt-1" to="/login">
          Login
        </NavLink>
      </li>
      <li className="nav-item">
        <NavLink className="nav-link mt-1" to="/signup">
          Sign Up
        </NavLink>
      </li>
    </Fragment>
    ...
    <nav className="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav">
          <li className="nav-item">
            <NavLink className="nav-link mt-1" exact to="/">
              Home
            </NavLink>
          </li>
          ...
          />
          <li className="nav-item">
            <NavLink className="nav-link mt-1" to="/shop">
              Shop
            </NavLink>
          </li>
          <li className="nav-item">
            <NavLink className="nav-link mt-1" to="/cart">
              <img
                src={image}
                alt="cart image"
                style={{ maxHeight: "15px", marginRight: "3px" }}
              />
              <sup>
                <small
                  style={{
          ...
          <li className="lang nav-item nav-link mt-1">
            Language
            <ul className="lang-options">
              ...
              <li>
                <NavLink
                  to={{
                    pathname:
                      "https://dmuinoo.github.io/winesbierzo.github.io/",
                  }}
                  target="_top"
                >
                  Es
